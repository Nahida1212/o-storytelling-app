...
/// 获取所有有已生成音频的小说
#[tauri::command]
pub fn get_novels_with_audio(
    app: AppHandle,
) -> Result<Vec<db_service::NovelWithAudioInfo>, String> {
...
pub fn get_chapters_with_audio(
    ...
    db_service::get_chapters_with_audio(&app, novel_id)
        .map_err(|e| format!("获取有声章节列表失败: {}", e))
}
